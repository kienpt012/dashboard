...
Mỗi đóng góp ghi rõ trạng thái bằng chứng. Kết quả và dữ liệu tái lập được tổng hợp trong [nhật ký thí nghiệm](experiments/README.md).
...
- **[đã có bằng chứng]** E-003 đo độ chính xác theo trường trên dataset-v1; CER OCR trên scan chất lượng thấp vẫn cần bổ sung.
...
- **[đã có bằng chứng]** hiện thực hoàn chỉnh trong `candidates.ts` / `extraction-worker.ts`; bộ kiểm thử hồi quy tiếp tục được duy trì khi tích hợp lớp AI.
...
- **[đã có bằng chứng]** E-003 ghi nhận rule-based đạt F1 0,75 và LLM/hybrid đạt F1 1,0 trên dataset-v1; phạm vi dữ liệu synthetic được nêu rõ trong tài liệu kết quả.
...
- **[đã có bằng chứng]** chuỗi quyết định D-001…D-008 kèm căn cứ trong [nhật ký quyết định](DECISIONS.md); số đo hiệu năng nền tảng E-001/E-002.
- **[chờ thí nghiệm]** đánh giá hiệu quả nghiệp vụ (RQ4) và đánh giá định lượng IOC Copilot (RQ5).
